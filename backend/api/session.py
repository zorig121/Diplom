...
async def request_session(current_user=Depends(get_current_user)):
    ...
    # Хэрвээ session өмнө нь үүссэн байвал шууд буцаана
    ...
    # Session мэдээлэл RAM-д хадгалах
    ...
    # Автоматаар хугацаа дуусахад container зогсоох
